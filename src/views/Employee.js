...
class Employee extends Component {
  ...
  employeeHasAllRequiredFields() {
    return (
      !!this.state.employee.name && !!this.state.employee.position && !!this.state.employee.wage
    );
  }
  ...
  renderTimesheetButtons(timesheet, timesheetIndex) {
    ...
    if (
      ...
      saveButton = (
        <a className={'button'} onClick={this.saveTimesheet.bind(this, timesheetIndex)}>
          Save
        </a>
      );
    } else {
    ...
    if (this.timesheetHasChanges(timesheet, timesheetIndex)) {
      cancelButton = (
        <a className={'button'} onClick={this.cancelTimesheetEdit.bind(this, timesheetIndex)}>
          Cancel
        </a>
      );
    } else {
  ...
  renderTimesheets() {
    ...
    const timesheets = this.state.timesheets.map((timesheet, timesheetIndex) => {
      return (
        <div className="timesheet" key={timesheet.id}>
    ...
    return (
      <div className="Employee">
        ...
        <div className="employee">
          ...
          <p className="strong">
            Name: <input onChange={this.updateEmployeeName} value={employee.name} />
          </p>
          <p>
            Position: <input onChange={this.updateEmployeePosition} value={employee.position} />
          </p>
          <p>
            Wage: ${' '}
            <input onChange={this.updateEmployeeWage} value={employee.wage} type="number" /> /
            hour
          </p>
